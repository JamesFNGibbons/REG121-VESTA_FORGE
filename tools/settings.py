...
def _settings_for(lib: Path) -> Settings:
    return Settings(
        ...
        litellm_embedding_model=os.getenv("LITELLM_EMBEDDING_MODEL", "qwen3-embedding-8b").strip(),
        # Qwen3-Embedding-8B full output is 4096 dims (MRL); must match LiteLLM model output.
        dense_vector_size=int(os.getenv("DENSE_VECTOR_SIZE", "4096")),
